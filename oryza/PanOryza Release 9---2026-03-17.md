...
There are a total of **37 genomes** in GrameneOryza: 28 rice genomes, 8 plant outgroups (_Leersia perrieri_ - the nearest outgroup of the genus Oryza in the Oryzeae tribe, two versions of B73 maize: V4 and V5, _Sorghum bicolor_, _Arabidopsis thaliana_, grapevine, Selaginella, and Chlamydomonas - a single-celled green algae), and fruit fly Drosophila, in order to allow comparisons between higher eukaryotes, lower plants, and the model Arabidopsis.
