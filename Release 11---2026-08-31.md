...
In its eleventh release, SorghumBase (SB) features 2 new _Sorghum bicolor_ ssp. _bicolor_ genomes, 7 existing genomes with updated gene sets, all selected from the community prioritized list. The site now hosts a total of 123 sorghum genome assemblies. Protein-coding gene family analysis constructed 49,923 gene trees from 2,673,286 input gene models representing 70 sorghum and 8 outgroup genomes. Standard identifiers for genetic variation (rsIDs) assigned by the European Variation Archive (EVA) to variants called on BTx623 v3 have been projected to 100 other sorghum assemblies. This resource allows traits to be anchored to stable identifiers and accessed in a pan-genome context.
...
We are providing in this release, 31 new [genome assemblies](https://ensembl.sorghumbase.org/species.html) from the JGI SorghumPan project. An analysis of these genomes is available on bioRxiv [doi:10.1101/2025.08.01.667986](https://doi.org/10.1101/2025.08.01.667986)
 
***Genetic & Phenotypic Variation***

- Sorghum BTx623 (NCBIv3)

  * 46 million rsIDs were mapped from BTx623 v3.1 to 100 sorghum accessions

### New Features

By default, the taxonomic distribution of search results doesn't show genomes with 0 matching genes or genomes that are not part of the Compara gene tree analysis. Two buttons at the top of the page let you toggle this feature on and off.
...
This release includes a total of 116 sorghum assemblies including four versions of BTx623: NCBIv3, JGIv5.1 (restricted under the [Fort Lauderdale Accord](https://www.sanger.ac.uk/wp-content/uploads/fortlauderdalereport.pdf), and two T2T assemblies in addition to eight plant outgroup species. See [release notes for version 6.0](https://www.sorghumbase.org/relnotes?section=Release%206) for more details. 


### Variation

Standard rsID identifiers assigned by the EVA were mapped to nearly 46 million SNPs in both BTx623 reference assemblies (NCBIv3 and JGIv5.1), as well as 99 other accessions including 46 ex-PVP breeding lines (see Variation column in the [Species Table](https://ensembl.sorghumbase.org/species.html) for a complete list. In addition, rsIDs were also assigned to Arabidopsis, Japonica rice and B73 maize SNPs.
