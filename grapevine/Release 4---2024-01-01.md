...
- Seven new grape reference genomes:
  ...
  Vitis riparia
  Vitis rupestris
  Vitis vinifera subsp. vinifera. Malbec ‘Magdeleine’
  Vitis vinifera subsp. vinifera. Malbec ‘Prunelard’
  Vitis vinifera subsp. vinifera. Tempranillo ‘Albillo’
  Vitis vinifera subsp. vinifera. Tempranillo ‘Benedicto’
  Vitis vinifera ssp. sylvestris VS-1
- Eighteen existing grape reference genomes including two versions of the partially inbred Pinot Noir reference (clone PN40024):
  ...
  The remaining grapevine genomes include thirteen *Vitis vinifera* (L.) ssp. *vinifera* varieties:
  [Cabernet Sauvignon (clone FPS08)](https://vitis-ensembl.gramene.org/Vitis_cabsauvignon),
  [Carménère (clone FPS02)](https://vitis-ensembl.gramene.org/Vitis_carmenere),
  [Chardonnay (clone FPS04)](https://vitis-ensembl.gramene.org/Vitis_chardonnay),
  [Concord (interspecific hybrid PI 588077)](https://vitis-ensembl.gramene.org/Vitis_concord10x),
  [Flame Seedless (clone Parlier)](https://vitis-ensembl.gramene.org/Vitis_flamepac),
  [Merlot (clone FPS15)](https://vitis-ensembl.gramene.org/Vitis_merlot),
  [Zinfandel (clone FPS03)](https://vitis-ensembl.gramene.org/Vitis_zinfandel),
  [Black Corinth Seeded (seeded Black Corinth or Zante Currant)](URL),
  [Black Corinth Seedless (seedless Black Corinth or Zante Currant)](URL),
  [Cabernet Franc Cl. 04 (Cabernet Franc)](URL),
  [Nebbiolo (Nebbiolo)](URL),
  [Riesling (Riesling)](URL);
  ...
  [_V. arizonica_ (Arizona grape, canyon grape or uva del monte)](URL),
  [_Muscadinia rotundifolia_ cv. Trayshed (Muscadine), also known as _V. rotundifolia_](URL),
