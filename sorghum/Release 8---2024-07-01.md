...
In its eight release, SorghumBase (SB) features 46 new _Sorghum bicolor_ ssp. _bicolor_ breeding lines with an expired Plant Variety Protection (ex-PVP) Act certificate sequenced by a team led by Dr. Todd Michael at the Salk Institute to a total of 74 sorghum genomes. A total of 1,450,260 sorghum gene models are provided for the 37 sorghum genomes that are not ex-PVP, and 66,928 sorghum pan-genes were created using annotations from the 28 sorghum genomes in SB release 7. The sorghum pan-genes were in turn mapped to each of the 46 ex-PVP accessions by a team led by Dr. Doreen Ware at CSHL. 
