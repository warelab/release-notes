...
In its eight release, SorghumBase (SB) features 46 new _Sorghum bicolor_ ssp. _bicolor_ breeding lines with an expired Plant Variety Protection (ex-PVP) Act certificate) sequenced by a team led by Dr. Michael Todd at the Salk Institute to a total of 88 sorghum genomes and XXX sorghum genes. Moreover, a total of 66,928 sorghum pan-genes created using annotations from 28 sorghum genomes in SB release 7 were mapped to each of the 46 ex-PVP accessions by a team led by Dr. Doreen Ware at CSHL. 

We are also providing variation sampled with nearly 23 million additional variants. The set by [Kumar and colleagues (2024)](https://www.sorghumbase.org/paper/24501) consisted of 19.7 million single nucleotide polymorphism (SNPs) and 2.7 million insertion deletions (indels) assesed 365 accessions including 332 individuals from the bioenergy association panel (BAP) by whole-genome sequencing (WGS). The [Lasky et al (2015)](https://www.sorghumbase.org/paper/24502) set consisted on characterizing 1943 georeferenced landraces at 404,627 SNPs.
...
* [Kumar et al (2024)](https://www.sorghumbase.org/paper/24501) - 19.7M SNPs + 2.7M indels, whole-genome sequencing 365 accessions (including 332 BAP)
