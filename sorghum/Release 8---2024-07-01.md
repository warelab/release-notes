...
Note: Only genomes, not Compara (lifoff of pangenomes as a pangene track; rsIDs mapped to these)

These will likely be included in R9:
...
- In addition, there are other Gates assemblies (may not overlap with Gates VCF) with no permission to publish (not described here), plus black sorghum and 2 genomes from Liz Cooper. Marcela will confirm (from genomes excel). Also pangenes data.
...
MARCELA add note on FL accord

KAPPEEL --> 2) SNPs called in the 46 ex-PVP lines in an effort led by Dr. Michael Todd of the Salk Institute and Dr. Nadia Shakoor at the Donald Danforth Plant Science Center? 
(then rsIDs mapped to the 30 (of the 46 ex-PVP breeding lines?) --_ Status?_
