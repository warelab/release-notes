...
- Visualization of GWAS hits from a meta-analysis of 234 phenotypic trait datasets on 406 accessions of the Sorghum Association Panel (SAP) extracted from 40 distinct studies and analyzed by [Mural _et al_ (2021)](https://www.sorghumbase.org/post/Inadvertent-Introgression:-Pleiotropy-and-the-Sorghum-Genome). Traits are searchable by trait ontology (TO) term.
