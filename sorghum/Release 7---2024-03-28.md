...
- Visualization of GWAS hits from a meta-analysis of 234 phenotypic trait datasets on 406 accessions of the Sorghum Association Panel (SAP) extracted from 40 distinct studies and analyzed by Mural _et al_ (2021).
...
No updates in the current release, please see [release notes for version 6.0](https://www.sorghumbase.org/relnotes?section=Release%206) for the ~70 million sorghum variants for BTx623 (NCBIv3) in SorghumBase.
...
GWAS hits from a meta-analysis of 234 phenotypic trait datasets from 40 studies on 406 SAP accessions performed by Mural _et al_ (2021).
