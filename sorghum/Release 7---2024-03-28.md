...
Members of the SorghumBase Team contributed to two new publications, one led by Dr. Yinping Jiao and Dr. Zhanguo Xin describing a large sequenced mutant library covering 98% of sorghum genes [(Jiao _et al_, 2023)](https://www.sorghumbase.org/paper/23165), and the other one by Dr. Yong Zhou and Dr. Rod Wing describing the HPC-based GATK4 pipeline used to call 32.5 million SNPs in Tx2873 [(Zhou _et al_, 2024)](https://sorghumbase.org/paper/23243).
