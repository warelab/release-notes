...
- [_Sorghum bicolor_ BTx623 v5](https://ensembl-dev.sorghumbase.org/Sorghum_bicolorv5) from [Phytozome](https://phytozome-next.jgi.doe.gov/info/Sbicolor_v5_1). Genes in this assembly have been included in gene family trees and assigned InterPro domains.
...
- 42,926 new gene trees with BTx623 v5.1
...
42,926 protein-coding gene family trees were constructed with the peptide encoded by
the canonical transcript (i.e., a representative transcript for a given gene) for each
of 1,233,135 individual genes (1,275,791 input proteins) from 36 plant genomes. Putative split genes are available for bulk download from [SorghumBase's FTP](https://ftp.sorghumbase.org/release-6/split_genes)
