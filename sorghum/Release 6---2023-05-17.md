...
With the BTx623 v5.1 assembled genome, there are a total of 29 sorghum genomes (36 plant genomes; 37 in total) in SorghumBase.
...
- 42,926 new gene trees with BTx623 v5.1. See [protein tree statistics](https://ensembl-dev.sorghumbase.org/prot_tree_stats.html?page=sizes)
