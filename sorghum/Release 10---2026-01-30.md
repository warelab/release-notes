...
In its tenth release, SorghumBase (SB) features 31 new _Sorghum bicolor_ ssp. _bicolor_ genomes from [JGI](https://phytozome-next.jgi.doe.gov/). The site now hosts a total of 116 sorghum genome assemblies. Protein-coding gene family analysis constructed 49,455 gene trees from 2,487,060 input gene models representing 76 sorghum and 8 outgroup genomes. Standard identifiers for genetic variation (rsIDs) assigned by the European Variation Archive (EVA) to variants called on BTx623 v3 have been projected to 100 other sorghum assemblies. This resource allows traits to be anchored to stable identifiers and accessed in a pan-genome context.
