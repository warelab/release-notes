...
This release incorporates the latest update from Plant Reactome in which 345 curated pathways involving 1,590 Oryza sativa japonica genes were projected via orthology to Sorghum bicolor BTx623 v3 and other anchor genomes shared with other Gramene sites.
