...
- Sorghum BTx623 (NCBIv3)
  ...
  * 41 million rsIDs were mapped from BTx623 v3.1 to 100 sorghum accessions
...
Nearly 41 million rsIDs mapped from EVA release 5 (July 2023) to the genetic variants in sorghum BTx623 NCBIv3 have been remapped to BTx623 JGIv5, 46 ex-PVP sorghum breeding accessions, and 53 additional sorghum genomes in SorghumBase (including 30 newly released in the current release 10).
...
* No updates in the current release, please see [release notes for version 9.0](https://www.sorghumbase.org/relnotes?section=Release%209) for the 36.1M SNPs, 940 resequenced sorghum genomes from the [Sorghum Genomics Toolbox](https://www.globalsorghuminitiative.org/) (Global Sorghum Initiative).
