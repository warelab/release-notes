...
There are updates for the gene expression data for the _S. bicolor_ BTx623 (NCBIv3) genome reference curated and processed through the [EMBL-EBI Expression Atlas](https://www.ebi.ac.uk/gxa/plant/experiments) consisting of 11 studies with baseline expression and 5 with differential expression. Baseline experiments, as well as expression of paralogs for the reference study and differential experiments along with eFP expression visualizations, are available through our Gene Search (Expression panel).  
Data for the eFP browser on the Expression tab of the SorghumBase search results have been updated form one studies to 10 expression studies.  
