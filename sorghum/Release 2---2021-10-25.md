...
has now released its second version. It provides access to 11 new sorghum varieties (Tao _et al_, 2021), bringining the total to 16 sorghum reference genomes,
...
- Eleven new sorghum reference genomes: 
  ...
  - _Sorghum bicolor bicolor_ (margaritiferum) ssp. IS19953
