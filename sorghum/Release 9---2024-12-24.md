...
In its ninth release, SorghumBase (SB) features 13 new _Sorghum bicolor_ ssp. _bicolor_ genomes including two telomere-to-telomere (T2T) assemblies of BTx623 (Li et al, 2024; Deng et al, 2024) to a total of 85 sorghum cultivars (88 assemblies).  
...
1) We are providing in this release, 13 new genome assemblies:
