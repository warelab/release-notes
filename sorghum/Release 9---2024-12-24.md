...
We are also providing variation sampled by the Gates-funded [Sorghum Genomics Toolbox (SGT)](https://www.globalsorghuminitiative.org/) Project (also known as the Global Sorghum Initiative) remapped to NCBIv3. This set consists of 36.1 million SNPs called in 940 resequenced genomes.
...
[**Gene Trees**](https://ensembl.sorghumbase.org/prot_tree_stats.html). There are 44,841 protein-coding gene family trees and (24,055) putative split genes for 48 plant genomes in SorghumBase (ex-PVP breeding lines excluded). 
