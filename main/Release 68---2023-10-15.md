...
No updates in this release. Genetic variation data continues to be available for 19 plant species, including _Arabidopsis thaliana_, maize,  rice (Japonica, Indica, _O. glaberrima_, and _O. glumaepatula_), brachypodium, cucumber, sunflower, barley, apple, tomato, sorghum, grapevine, bread and durum wheat, black bean, lettuce, and cocoa. Variation for the last three species is not yet available via BioMart.
