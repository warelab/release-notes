...
Release #67 features the Oryza CLIMtools portal brings interactive web-based views of environment x genome associations, RiboSNitch prediction, and correlations between the local environment and a pool of curated phenotypes in rice, in addition to Arabidopsis (Arabidopsis CLIMtools).
