...
The maize gene models, together with the seven outgroups were used to build 35,360 protein-coding gene family trees. In addition, 41 pairwise synteny maps were build with version 5 of the _Z. mays_ B73 genome. Data from 32 baseline gene expression studies from the EBI Expression Atlas, and 270 orthology-based pathway projections from the Plant Reactome are provided for B73 (v5).
...
- 41 pairwise synteny maps build with _Z. mays_ B73 v5
