...
- 143 pairwise synteny maps build with _Z. mays_ B73 v5
...
[**Synteny**](https://maize-pangenome-ensembl.gramene.org/compara_analyses.html). One-hundred and fourty-three synteny maps between Zea mays B73 v5 and all other genomes in the panmaize browser.
